...
class ProductTileWidegt extends StatelessWidget {
  final ProductDataModel productDataModel;
  final HomeBloc homeBloc;
  ProductTileWidegt({super.key, required this.productDataModel, required this.homeBloc});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                  onPressed: () {
                    homeBloc.add(HomeProductWishListButtonClickedEvent(clickProduct: productDataModel));
                  },
                  icon: Icon(Icons.favorite_border)),
              IconButton(
                  onPressed: () {
                    homeBloc.add(HomeProductCartButtonClickedEvent(clickProduct: productDataModel));
                  },
